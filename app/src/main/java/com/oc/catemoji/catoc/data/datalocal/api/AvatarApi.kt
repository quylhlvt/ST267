...
object ApiConfig {
    ...
    const val BASE_CONNECT = "public/app/ST242_AnimeCoupleMakerDressUp/"
...
interface AvatarApiService {
    @GET("api/app/ST242_AnimeCoupleMakerDressUp")
    ...
    fun map(raw: Map<String, List<X10>>): List<CustomModel> {
        ...
        return raw.entries
            ...
            .map { (key, list) ->
                ...
                // Mỗi nhân vật có nav đầu tiên riêng, xác định bằng zIndex nhỏ nhất.
                ...
                CustomModel(
                    ...
                    level      = list.firstOrNull()?.levelInt ?: Int.MAX_VALUE
                )
            }
    }
